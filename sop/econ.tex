...
While there, I worked with Professor Nicholas Hopper at the University of Minnesota developing a method for users of encrypted messaging apps to report abusive or misinformative content without weakening the guarantees of end-to-end encryption.
In my junior year, I presented preliminary work at a major conference.
I'm currently working on a manuscript based on these and related results.
...
I've appreciated how this project---and OI work more generally---uses clever econometric and computational techniques to bring quantitative clarity to an issue that was not previously well understood.
...
In particular, I propose to investigate how the surge of Chinese import competition beginning in the early 2000s affected the long-term outcomes of children raised in trade-exposed U.S. communities.
...
Are kids in textile manufacturing towns doing worse off than they were 30 years ago?%
% \footnote{
% 	I will use IRS and Census microdata for this project, which I have worked extensively with in my time at OI.
% }

Separately, another line of research has demonstrated that social mobility---as measured by the expected adult income of a child whose parents earn at the 25th percentile of the income distribution---has declined most in places where parental employment rates have also fallen \parencite{chetty-etal-2024-race-trends}.
This suggests a link between labor market conditions and children's outcomes, but the direction of causality remains unclear.
...
%
To approximate random import exposure, I will use the classic ``China Shock'' shift-share instrument \parencite[for example]{autor-etal-2025-places-people}. % to isolate an exogenous component of import exposure in the decade following China's 2001 admission to the World Trade Organization.
...
But this alone is insufficient: If high-ability families leave an area when work disappears, then simply comparing the outcomes of children growing up before and after the China Shock will overstate its effect.
%
To address this residential selection, I take inspiration from \textcite{chetty-etal-2024-race-trends} and leverage variation in the timing and destinations of moves to separate compositional shifts from changes in places' causal effects.

My goal is to identify yearly causal effects of each commuting zone on children's adult outcomes, which I can then use in an event study or a first-differences regression.%
\footnote{
...
Then, the difference in their mean outcomes reflects both the causal effect of spending 2000 in Minneapolis rather than Cleveland \emph{and} potential differences in the families that move in different years.
...
To identify $\{\mu_{zt}\}$---the causal effects of spending year $t$ in place $z$---I assume that there is no \emph{dynamic} selection into particular origin-destination pairs.\footnote{
...
With the shift-share instrument from \citeauthor{autor-etal-2025-places-people}, these time-varying place effects will allow me to identify the average impact of the China Shock on the quality of a place for children, as measured by its causal effect on adult earnings.
...
For example, in ongoing independent work \parencite{pattison-2025-polarization}, I develop a measure of public ideological polarization and show that it has been steadily increasing over the last several decades.
