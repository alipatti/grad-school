...
\newcommand\program{Princeton\xspace}
...
\noindent
I am applying to \program to become an academic economist conducting research in applied microeconomics and political economics.
...
I've appreciated how this work---and OI more generally---uses clever economic techniques to bring novel quantitative clarity to publicly relevant issues.
...
\footnote{
	For power, I could also package an event study into \autoref{eq:movers} and estimate everything in a single step.
}
\begin{equation}
	\label{eq:movers}
	y_i =
...
Identifying $\{\mu_{zt}\}$---the causal effects of spending year $t$ in place $z$---requires assuming that this selection into specific origin-destination pairs is static.%
\IfStrEq{\program}{Berkeley\xspace}{}{\footnote{
...
\IfStrEq{\program}{Berkeley\xspace}{}{%
