...
%
To address this residential selection, I take inspiration from \textcite{chetty-etal-2024-race-trends} and leverage variation in the timing and destinations of moves to identify yearly causal effects of each commuting zone on children's adult outcomes. 
...
Identifying $\{\mu_{zt}\}$---the causal effects of spending year $t$ in place $z$---requires asusming that this selection on origin-destination pairs is static.\footnote{
